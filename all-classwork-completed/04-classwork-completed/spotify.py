...
print("My name is", name, "and I am", height, "feet tall")

sent = 'My name is {} and I am {}\' tall'.format('Soma', 40040404)
print(sent)

sent = 'My name is {name} and I am {height} feet tall'.format(name='Soma', height='600')
print(sent)
...
sent = "My name is {name} and I am {height:07} feet tall".format(**person)
print(sent)

sent = 'My name is {} and I am {:07}\' tall'.format('Soma', 44)
print(sent)
...
total_duration = 0
for song in songs:
  total_duration = total_duration + song['duration_ms']
  print("Song is", song['duration_ms'], "Total so far is", total_duration)

duration_min = total_duration / 1000 / 60
print("Total duration is", round(duration_min, 2))

durations = []
for song in songs:
  durations.append(song['duration_ms'])
  print("Looking at", song['name'], ", I now have", len(durations), "durations")
print("Final list is", durations)
print("Total duration is", sum(durations))
...
for number in numbers:
  bigger_numbers.append(number * 2)
  print("bigger_numbers is", bigger_numbers)
  # print(number * 2)
...
song_durations = [song['duration_ms'] for song in data['tracks']]
print(sum(song_durations))
...
for song in songs:
  ...
  joined_artists = " ".join(artist_names)
  print("Musicians that worked on", song['name'], "are....", joined_artists)
...
# album_songs = [song for song in songs]


for song in songs:
  print(song['album']['album_type'])

album_types = [song['album']['album_type'] for song in songs]
print("Album types are", album_types)
print(album_types.count('album'), "are albums")
print(album_types.count('single'), "are singles")


singles = [song for song in songs if song['album']['album_type'] == 'single']

names = [song['name'] for song in songs if song['album']['album_type'] == 'single']
...
# Makes a copy of your list
# but ONLY KEEPS the elements that
# the 'if' statement is true for
[song for song in songs if song['duration_ms'] > 20000]
